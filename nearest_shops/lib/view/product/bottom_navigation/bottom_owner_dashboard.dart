...
class BottomOwnerNavigatorDashboardListModel {
  ...
  BottomOwnerNavigatorDashboardListModel() {
    _navigatorModelItems = [
      ...
      BottomNavigatorModel(Icons.list, LocaleKeys.bottomProductsText.locale),
      BottomNavigatorModel(Icons.add_shopping_cart_sharp, LocaleKeys.bottomProductAddText.locale),
